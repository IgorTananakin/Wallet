...
<form action="<?php echo admin_url('options.php') ?>" method="post">
    ...
    <div class="input-box">
        ...
        <div class="input">
            ...
            <div class="helper">?
                <div class="tip">
                    <?php echo __('If account balance is not enough discount the available funds from the accounts balance and pay the rest using a diffret payment gateway.',
                        'fsww'); ?>
                </div>
            </div>
        </div>
    ...
    <div class="input-box">
        ...
        <div class="input">
            <input class="input-field" name="fsww_deposit_input_min" id="fsww_deposit_input_min" type="number"
                   placeholder="0" min="0" value="<?php echo esc_attr(get_option('fsww_deposit_input_min', '0')); ?>">
        </div>
    </div>
