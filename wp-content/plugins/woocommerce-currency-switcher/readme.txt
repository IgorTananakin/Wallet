...
WooCommerce Currency Switcher is free currency plugin for woocommerce and multi currency shop that allows to switch products prices and pay in the selected currency
...
Q: API?
R: [currency-switcher.com/codex](https://currency-switcher.com/codex/)

Q: Documentation?
R: [currency-switcher.com/documentation](https://currency-switcher.com/documentation/)

Q: Videos?
R: [currency-switcher.com/video-tutorials](https://currency-switcher.com/video-tutorials/)

Q: More FAQ answers?
R: [currency-switcher.com/category/faq](https://currency-switcher.com/category/faq/)
